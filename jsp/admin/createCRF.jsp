...
<h1><span class="title_manage"><fmt:message key="create_a_new_CRF_case_report_form" bundle="${resworkflow}"/></span></h1>
...
<table>
  <tr><td class="formlabel"><fmt:message key="CRF_name" bundle="${resword}"/></td><td>
