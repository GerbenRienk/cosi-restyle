...
<!-- start managestudy/findSubjects.jsp -->
...
<!-- end div findSubjectsDiv -->
<div id="addSubjectForm" style="display:none;"><c:import url="../submit/addNewSubjectExpressNew.jsp"></c:import></div>
<br />
<script type="text/javascript">
...
<!-- end managestudy/findSubjects.jsp -->